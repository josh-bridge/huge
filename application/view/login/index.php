<div class="container">
    ...
    <div class="login-page-box">
        <div class="table-wrapper">
            ...
            <div class="login-box">
                <h2>Login here</h2>
                <form action="<?php echo Config::get('HTTPS_URL'); ?>login/login" method="post" onSubmit="saveItems()">
                ...
                <div class="link-forgot-my-password">
                    <a href="<?php echo Config::get('HTTPS_URL'); ?>login/requestPasswordReset">I forgot my password</a>
                </div>
            </div>
