...
return array(
	...
	"FEEDBACK_REQUIRED_FIELDS_EMPTY" => "Some required fields were left empty.",
	...
	"FEEDBACK_USERNAME_DOES_NOT_FIT_PATTERN" => "Username is not valid: only a-Z and numbers are allowed, 2 to 64 characters.",
	"FEEDBACK_EMAIL_DOES_NOT_FIT_PATTERN" => "Sorry, your chosen email is not valid.",
	"FEEDBACK_FIRSTNAME_DOES_NOT_FIT_PATTERN" => "Sorry, the first name entered is not valid. Only alphabetical chars, 2 to 64 chars.",
	"FEEDBACK_LASTNAME_DOES_NOT_FIT_PATTERN" => "Sorry, the last name entered is not valid. Only alphabetical chars, 2 to 64 chars.",
	"FEEDBACK_DOB_DOES_NOT_FIT_PATTERN" => "Sorry, the date of birth entered is not valid. Please ensure the date exists & the format is (dd/mm/yyyy).",
	"FEEDBACK_DOB_DOES_NOT_EXIST" => "Sorry, the date of birth you entered does not exist.",
	"FEEDBACK_DOB_AGE_TOO_LOW" => "Sorry, users must be 18 years old or higher.",
	"FEEDBACK_ADDRLINE1_DOES_NOT_FIT_PATTERN" => "Sorry, Address (Line 1) is not valid. Alphanumeric chars and dashes only, 2 to 64 chars.",
	"FEEDBACK_ADDRLINE2_DOES_NOT_FIT_PATTERN" => "Sorry, Address (Line 2) is not valid. Alphanumeric chars and dashes only, 2 to 64 chars.",
	"FEEDBACK_ADDRLINE3_DOES_NOT_FIT_PATTERN" => "Sorry, Address (Line 3) is not valid. Alphanumeric chars and dashes only, 2 to 64 chars.",
	"FEEDBACK_POSTCODE_DOES_NOT_FIT_PATTERN" => "Sorry, the postcode entered is not valid. Valid UK postcodes only.",
	"FEEDBACK_CITY_DOES_NOT_FIT_PATTERN" => "Sorry, the city name entered is not valid. Alphanumeric chars and dashes only, 2 to 64 chars.",
	"FEEDBACK_COUNTRY_DOES_NOT_FIT_PATTERN" => "Sorry, the country name entered is not valid. Alphanumeric chars and dashes only, 2 to 64 chars.",
	"FEEDBACK_TELEPHONE_DOES_NOT_FIT_PATTERN" => "Sorry, the telephone number entered is not valid.",
	"FEEDBACK_MOBILE_DOES_NOT_FIT_PATTERN" => "Sorry, the mobile number entered is not valid.",
	"FEEDBACK_BUSINESS_DOES_NOT_FIT_PATTERN" => "Sorry, the business name entered is not valid. Alphanumeric chars and dashes only, 2 to 64 chars.",
